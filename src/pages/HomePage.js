...
import OurGuides from 'containers/OurGuides';
  ...
  return (
    <main className={styles.wrapper}>
      ...
      <ReadMoreTextBlock bgColor='grey' isReverseOrder>
        <h3>How it works?</h3>
        <p>
          Guides can set up their profile and are approved based on their level of experience, their
          cultural and regional knowledge and past reviews. We recommend all guides follow our guide
          standards document. Once approved, guides remain in control of the itineraries they
          create. They work out the trip schedule they want us to promote and the price they wish to
          charge for their services, leaving GreatGuides.com to take care of admin behind the
          scenes.
        </p>
        <p>
      ...
      <ReadMoreTextBlock bgColor='white'>
        ...
        <p>
          GreatGuides.com facilitates direct bookings between the adventure traveller and the guide
          ensuring an independent rather than a corporate experience. Until now, that’s been
        ...
        <p>
          Via GreatGuides.com, the guides get to keep the majority of their fee, rather than losing
          much of it to intermediary tour operators. Travellers can therefore leave home secure in
          the knowledge that they’re supporting the local economy without risking the quality…
        </p>
